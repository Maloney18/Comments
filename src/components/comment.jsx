...
import { decCommScore, deleteComment, incCommScore, toggleCommRepBar, toggleComDelBar } from "../dataBase/Features/generalData"

const Comment = (props) => {
    const dispatch = useDispatch()
    const { data } = useSelector(store => store.generalData)
    const { user, createdAt, content, score, id, open, deleteTog } = props?.comments
    console.log(props)
