...
import { decCommScore, deleteComment, incCommScore, toggleCommRepBar } from "../dataBase/Features/generalData"

const Comment = (props) => {
    const dispatch = useDispatch()
    const { data } = useSelector(store => store.generalData)
    const { user, createdAt, content, score, id, open } = props?.comments
                ...
                <div className="anyone">
                    ...
                    <div className="lower">
                        <div className="score">
                            <span 
                                className="inc"
                                onClick={() => dispatch(incCommScore(id))}
                            >
                        ...
                        
                        {
                            ...
                            <div className="icon-cont flex">
                                <div className="del-icon flex" onClick={() => dispatch(deleteComment(id))}>
