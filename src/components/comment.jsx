...
import { decCommScore, deleteComment, incCommScore, toggleCommRepBar, toggleComDelBar, toggleEditBar, updateCommentAndReply } from "../dataBase/Features/generalData"
import { useState } from 'react'

const Comment = (props) => {
    const dispatch = useDispatch()
    const { data } = useSelector(store => store.generalData)
    const { user, createdAt, content, score, id, open, deleteTog, edit } = props?.comments
